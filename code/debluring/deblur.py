...
parser.add_argument('--preview', type=bool, help="Do not save results, but show them",
                    default=True)
parser.add_argument('--kowalsky', type=float, help="factor to enhance divition",
                    default=0.0001)
parser.add_argument('--output', type=str, help="output path to store result images",
                    default=str(root_path / 'results'))

args = parser.parse_args()
preview = True if args.output else False
